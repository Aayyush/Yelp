...
1.  Using the Google Maps API to recommend places to friends.
2.  Implementing a favourites tool to mark places as favourite.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/1IlwFEU.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
The tutorial was based on Swift 3. As a result, I had to make some tweaks to the code to make it work.
